 ...
 *
 * @param {string} prefix Network prefix. E.g.: 'spectretest'.
 */
...
const spectreNetworks = ['spectre', 'spectredev', 'spectrereg', 'spectretest', 'spectresim'];

spectreNetworks.map((str) => {
  addNetwork({
    name: str,
    prefix: str,
    pubkeyhash: 0x00, // publickey hash prefix
    privatekey: 0x80, // privatekey prefix -- must be 128 or toWIF() result will not match with spectre
    scripthash: 0x05,
