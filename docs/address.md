...
The errors are listed in the generated file in the [errors folder](https://github.com/bitpay/bitcore/tree/master/packages/spectrecore-lib/lib/errors). There's a structure to errors defined in the [spec.js file](https://github.com/bitpay/bitcore/blob/master/packages/spectrecore-lib/lib/errors/spec.js).
