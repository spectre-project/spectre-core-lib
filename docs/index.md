...
var imported = spectrecore.PrivateKey.fromWIF(exported);
...
var p2shAddress = new spectrecore.Address([publicKey1, publicKey2, publicKey3], 2);
```
...
var uri = new spectrecore.URI(paymentInfo).toString();
```
