...
var HDPrivateKey = spectrecore.HDPrivateKey;
var HDPublicKey = spectrecore.HDPublicKey;
...
describe('BIP32 compliance', function() {
  ...
  describe('edge cases', function() {
    ...
    it('will handle edge case that derived private key is invalid', function() {
      ...
      var unstubbed = spectrecore.crypto.BN.prototype.toBuffer;
      var count = 0;
      var stub = sandbox.stub(spectrecore.crypto.BN.prototype, 'toBuffer').callsFake(function (args) {
      ...
      sandbox.spy(spectrecore.PrivateKey, 'isValid');
      var key = HDPrivateKey.fromObject({
        network: 'testnet',
        depth: 0,
        parentFingerPrint: 0,
      ...
      spectrecore.PrivateKey.isValid.callCount.should.equal(2);
    });
    it('will handle edge case that a derive public key is invalid', function() {
      ...
      var unstubbed = spectrecore.PublicKey.fromPoint;
      spectrecore.PublicKey.fromPoint = function() {
        spectrecore.PublicKey.fromPoint = unstubbed;
