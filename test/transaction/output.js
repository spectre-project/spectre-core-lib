...
var BufferWriter = spectrecore.encoding.BufferWriter;
var BufferReader = spectrecore.encoding.BufferReader;
...
describe("Output", function() {
  ...
  it("#toObject roundtrip will handle an invalid (null) script", function() {
    ...
    var br = new spectrecore.encoding.BufferReader(invalidOutputScript);
