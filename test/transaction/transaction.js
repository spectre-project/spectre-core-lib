...
var BN = spectrecore.crypto.BN;
var Transaction = spectrecore.Transaction;
var Signature = spectrecore.Signature;
var Input = spectrecore.Transaction.Input;
var Output = spectrecore.Transaction.Output;
var PrivateKey = spectrecore.PrivateKey;
var Script = spectrecore.Script;
var Address = spectrecore.Address;
var Networks = spectrecore.Networks;
var Opcode = spectrecore.Opcode;
var errors = spectrecore.errors;
...
describe('Transaction', function() {
  ...
  it('fromObject with pay-to-public-key previous outputs', function() {
    var tx = spectrecore.Transaction({
    ...
    tx.inputs[0].should.be.instanceof(spectrecore.Transaction.Input.PublicKey);
  ...
  describe('checks on adding inputs', function() {
    ...
    it('will add an empty script if not supplied', function() {
      ...
      transaction.inputs[0].output.script.should.be.instanceof(spectrecore.Script);
